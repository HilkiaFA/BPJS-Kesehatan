                ...
                <form action="Insertuser.php" method="post">
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" required name="NamaUser" id="NamaUser">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" required name="Username" id="NamaUser">
                        </div>
                        <div class="col-md-6">
                            <label for="Jabatan" class="form-label">Password</label>
                            <input type="text" class="form-control" required name="Password" id="Jabatan">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div>
                            <label for="kodeBidang" class="form-label">Kode Bidang</label>
                            <input type="text" class="form-control" required name="kodeBidang" id="kodeBidang">
                        </div>
                        <div class="col-md-12">
                            <label for="Bidang" class="form-label">Bidang</label>
                            <select class="form-select" name="bidang">
                                <option>Mitra Layanan Fasilitas Kesehatan</option>
                                <option>Pengelola Harta dan Utilisasi</option>
                                <option>Keuangan</option>
                                <option>Kepesertaan</option>
                            </select>
                        </div>
                    </div>
